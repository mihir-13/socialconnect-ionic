...
export class PeoplePage {
  ...
  GetUsers(name) {
    this.usersProvider.GetAllUser().subscribe(data => {
  ...
  ViewProfile(value) {
    this.navCtrl.push('ViewUserProfilePage', { userData: value });
    this.usersProvider.ProfileNotifications(value._id).subscribe(data => {
